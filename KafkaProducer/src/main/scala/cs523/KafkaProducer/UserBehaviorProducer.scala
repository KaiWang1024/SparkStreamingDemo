...
class UserBehaviorProducer(brokers: String, topic: String) extends Runnable {
...
object UserBehaviorProducerClient {
    def main(args: Array[String]) {
        ...
        new Thread(new UserBehaviorProducer(brokers, topic)).start()
    }
}